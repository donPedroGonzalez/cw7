...
{   
    ...
    firstPart = [ "Uzupełnij zdania odpowiednimi przymiotnikami opisującymi cechy charakteru.", "Marie sourit toujours et raconte des histoires amusantes. Elle est très ", "Pierre ne partage jamais ses bonbons avec ses amis. Il est ", "Sophie dit toujours la vérité. Elle est ", "Mon professeur ne sourit jamais et ne fait jamais de blagues. Il est très ", "Lucas aide toujours les autres et donne son argent aux pauvres. Il est ", "Ma voisine est toujours de mauvaise humeur et n'est jamais contente. Elle est ", "Mon frère attend toujours son tour sans se plaindre. Il est très ", "Julie pense que tout va bien se passer dans la vie. Elle est ", "Ce garçon dit toujours 'bonjour' et 'merci'. Il est très ", "Ma sœur pleure souvent et n'est jamais contente. Elle est ", "Thomas fait toujours ses devoirs avec attention. Il est ", "Cette fille parle avec tout le monde et aime les fêtes. Elle est très ", "Mon ami pense toujours qu'il est le meilleur. Il est ", "Le nouveau directeur écoute tout le monde et ne se vante jamais. Il est ", "Ma grand-mère dit des choses gentilles à tout le monde. Elle est très ", "Ce professeur comprend tout très vite et a toujours de bonnes idées. Il est ", "Mon oncle ne peut pas attendre deux minutes! Il est très ", "Cette personne fait semblant d'être gentille mais dit du mal des autres. Elle est ", "Mon cousin danse et chante dans la rue. Il est très ", "J'aime bien Paul, il est vraiment " ];
    secondPart = [ "Complétez les phrases avec l'adjectif de personnalité qui convient.", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "!" ];
    missingElement = [ "Les adjectifs de personnalité", "drôle", "avare", "sincère", "sérieux", "généreux", "désagréable", "patient", "optimiste", "poli", "triste", "consciencieux", "sociable", "prétentieux", "humble", "gentille", "intelligent", "impatient", "hypocrite", "exubérant", "sympathique" ];
    hints = [ "nan", "≠ ennuyeux", "≠ généreux", "≠ hypocrite", "≠ drôle", "≠ avare", "≠ agréable", "≠ impatient", "≠ pessimiste", "≠ impoli", "≠ gaie/joyeuse", "≠ désinvolte", "≠ introvertie", "≠ modeste", "≠ arrogant", "≠ méchante", "≠ stupide", "≠ patient", "≠ sincère", "≠ réservé", "≠ antipathique" ];
